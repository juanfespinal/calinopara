...
export const places: Place[] = [
  ...
  },
  {
    ...
    menu: [
      ...
      {
        name: "Perro XXXL",
        desc: "Perro con salchicha de 30 cm, salsas de la casa, ripio, queso, dos sabores a elección y papas a la francesa.",
        price: 50000,
      },
      {
        name: "El Original",
      ...
      { name: "Limonada", desc: "Con zumo de limón natural.", price: 9000 },
      { name: "Limonada cerezada", desc: "Con zumo de limón natural.", price: 14000 },
      { name: "Limonada de coco", desc: "Con crema de coco y leche Klim.", price: 16000 },
      { name: "Sunrise", desc: "Maracuyá y fresa.", price: 19000 },
      { name: "Lulada de la Novena", desc: "Lulo y cereza.", price: 19000 },
      { name: "Colombiana 400 ml", desc: "Gaseosa Colombiana.", price: 6000 },
      { name: "Coca-Cola sabor original 400 ml", desc: "Gaseosa.", price: 6000 },
      { name: "Postobón Manzana 400 ml", desc: "Gaseosa Postobón Manzana.", price: 6000 },
      { name: "Frozen maracumango", desc: "Granizado de maracumango con trozos de mango.", price: 16000 },
      { name: "Frozen lulada", desc: "Granizado de lulo con trozos de lulo y leche condensada.", price: 16000 },
      { name: "Frozen mango Tajín", desc: "Granizado de mango con trozos de mango y Tajín.", price: 16000 },
      { name: "Frozen frutos rojos", desc: "Granizado de frutos rojos y leche condensada.", price: 16000 },
    ],
  },
  {
    slug: "tjaditos",
